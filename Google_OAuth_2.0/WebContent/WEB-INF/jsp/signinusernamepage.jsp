...
<body>
	...
	<div style="height: 60%; width: 100%;">
		<div align="center">
			...
			<form:form action="/google/user/password" method="post" modelAttribute="singlevalueform">
			<br /> <input type="text" id="value" name="value" /> <br /> <br />
			<input type="submit" value="Next"/>
			</form:form>
			<br /> <br /> <br /> <a href="/google/user/create"><label
